...
from anamika import anon, app, config, db, lang
from anamika.helpers import buttons, can_manage_vc


@app.on_message(filters.command(["pause"], config.PREFIX) & filters.group & ~app.bl_users)
@lang.language()
@can_manage_vc
